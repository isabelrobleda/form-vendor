          ...
          <div className="border-b border-gray-900/10 pb-12">
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2 ">
                  <p className="mt-1 text-sm leading-6 text-gray-600">Alto</p>
                  <input
                    type="text"
                    id="height"
                    name="height"
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600 mx-2">
                    Fondo
                  </p>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                        <label
                            htmlFor="payment"
                            className="block text-sm font-medium leading-6 text-gray-900"> Quiero cubrir el envío como incentivo para el comprador</label>
                      <select
                        id="payment"
                        name="payment"
